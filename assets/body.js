tom=0;jikapr=1;ftganti=0;flag=1;flagg=1;fungsi=0;Bn2.innerHTML=Bn.innerHTML;psnWA.style.display="none";function showDiv() {pesanwhatsapp = psnWA.innerHTML;Bn2.style.display="none";Content.style = "opacity:1;margin-top:15vh;";ket.style="margin-top:30px";}
  ...
  async function menuju(){await swals.fire('OK!', 'Kirim pesan ke WhatsApp aku, ya!', 'success');
    var pesanwhatsapp = "?text=Halo, Aku Mau Jadi Temen Kamu:)!";
    window.location = "https://wa.me/6288980840381" + pesanwhatsapp;
